    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="total">
                <td colspan="4">&nbsp;</td>
                <td style="width: 50%">
                    <p>{{ trans('plugins/ecommerce::products.form.sub_total') }}: {!! htmlentities(format_price($order->sub_total)) !!}</p>
                    <p>{{ trans('plugins/ecommerce::products.form.shipping_fee') }}: {!! htmlentities(format_price($order->shipping_amount)) !!}</p>
                    <p>{{ trans('plugins/ecommerce::products.form.discount') }}: {!! htmlentities(format_price($order->discount_amount)) !!}</p>
                    <p>{{ trans('plugins/ecommerce::products.form.total') }}: {!! htmlentities(format_price($order->amount)) !!}</p>
                </td>
            </tr>
        </table>
    </div>
